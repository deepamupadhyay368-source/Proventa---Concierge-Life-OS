...
export const metadata: Metadata = { title: 'Dining Concierge — Proventa', description: 'Restaurant reservations, dining recommendations, and special occasion planning in Ahmedabad.' };
