...
export const VALID_TRANSITIONS: Record<TaskStatus, TaskStatus[]> = {
  ...
  OPTIONS_READY: ['AWAITING_APPROVAL', 'APPROVED', 'EXECUTING', 'COMPLETED', 'NEEDS_HUMAN', 'CANCELLED'],
  ...
  EXECUTING: ['VERIFYING', 'CONFIRMED', 'COMPLETED', 'NEEDS_HUMAN', 'FAILED', 'CANCELLED'],
